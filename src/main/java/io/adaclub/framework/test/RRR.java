...
public class RRR {
    public static void main(String[] args) {
        ...
        BestOne bestOne = BollTest.tryOnce(stockMetaDOs,today,wallet,11,17,9,true);
        System.out.println(bestOne.getResult().getMaxRetracement()*100+" vs "+bestOne.getResult().getProfit());
    }
}
